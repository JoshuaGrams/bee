...
def random_n_tests(n, base_path='random_test_outputs', dump_stats=0, starting_index=0):
    for i in range(n):
        i = starting_index + i
        output_path = base_path + '/{:03d}_output.txt'.format(i)
        script_path = base_path + '/{:03d}_script.txt'.format(i)
        data_path = base_path + '/{:03d}_data.txt'.format(i)
...
if __name__ == '__main__':
    print(file_path)
    random_n_tests(100, base_path = 'random_test_outputs_3', starting_index=0)
